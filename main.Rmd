...
config_path <- "~/Downloads/vpngate_vpn541986795.opengw.net_udp_1349.ovpn"
...
vpn_brazil <- vpngate_select(servers, c("country_long" = "Peru"))
...
vpngate_fast$connect(authentification = T, quiet = F, time_out = 40)
