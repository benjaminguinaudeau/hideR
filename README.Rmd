...
novpn_init(dir = ".") # Only run once

configs <- novpn_get_configs(dir = ".")
config <- sample(configs, 1)

novpn <- novpn_new_tunnnel(config)

# pwd <- ""
novpn$connect(username = "benjamin.guinaudeau@uni-konstanz.de", password = pwd,
