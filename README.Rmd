...
# hideR <img src="man/figures/hideR.png" width="160px" align="right" />


```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = TRUE, eval = FALSE)

# pacman::p_load(tidyverse, glue, rlang, furrr, rvest, keyring)
...
```{r}
# "https://nordvpn.com/fr/ovpn/"
# library(hideR)

nord_vpn_init(dir = ".") # Only run once

configs <- nord_vpn_get_configs(dir = ".")
config <- sample(configs, 1)

novpn <- nord_vpn_new_tunnnel(config)

# pwd <- ""
nord_vpn$connect(username = "benjamin.guinaudeau@uni-konstanz.de", password = pwd,
            authentification = T, quiet = F, prune_password = F)
